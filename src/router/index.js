...

  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "Comunicados" */ "../views/Comunicados.vue"
          ),
        meta: { requiresAuth: true },
      },
      {
...

      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "Donaciones" */ "../views/Donaciones.vue"
          ),
        meta: { requiresAuth: true },
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "Certificados" */ "../views/Certificados.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "DonacionesPuntuales" */ "../views/DonacionesPuntuales.vue"
          ),
      },
...

      {
        ...
        name: "News",
        component: () =>
          import(/* webpackChunkName: "Profile" */ "../views/News.vue"),
        meta: { requiresAuth: true },
      },
    ],
  },
