<template>
  <div class="container">
    ...
    <form enctype="multipart/form-data" novalidate v-if="isInitial || isSaving">
     ...
     <!--SUCCESS-->
      <div v-if="isSuccess">
        <h2>Se {{ (fileCount.length != '1' ) ? "han" : "ha" }} subido {{ fileCount }} {{ (fileCount.length != '1' ) ? "archivos" : "archivo" }} correctamente.</h2>
        <p>
          <a href="javascript:void(0)" @click="reset()">Subir un archivo de nuevo</a>
        </p>
      </div>
