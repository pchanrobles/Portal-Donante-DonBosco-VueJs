<template>
   ...
   <div class="head">
      ...
      <div class="text--primary">
        Las necesidades que reconocemos en nuestra sociedad son muchas. Con tu
        ayuda, la Fundación interviene fundamentalmente en el cambio de tu
        ámbito local y autonómico. Las principales líneas de trabajo que
        impulsamos en los distintos proyectos que existen tu localidad se
        orientan a:
        <ul class="list">
          <li class="li">
            Proteger y custodiar a los/las menores que no tienen una familia,
            dotándoles de un hogar donde crecer integralmente como personas
          </li>
          <li class="li">
            Fomentar la autonomía de las personas migrantes o extuteladas que
            buscan ser buenas personas y honrados ciudadanos.
          </li>
          <li class="li">
            Contribuir a erradicar la pobreza de una falta de formación
            educativa y capacitación laboral.
          </li>
          <li class="li">
            Promover la inserción sociolaboral de las personas adultas y de las
            familias que viven en situaciones de riesgo o están en exclusión.
          </li>
          <li class="li">
            Ayudar a la población infantil y sus familias a tener oportunidades
            y recursos socioeducativos para superar el riesgo de pobreza
            infantil.
          </li>
        </ul>
      </div>
      ...
      <br />
            ...
            <div class="h2"><img id="icon" src="../assets/icon.png" alt="icon" width="25px;"><h2  class="h2">
        ¿Qué formas tienen las personas jurídicas de colaborar con la Fundación
        Don Bosco Salesianos Social?
      </h2></div> 

      
      <div class="text--primary">
        Cuantos quieran apoyar la misión de la Fundación pueden hacerlo de mil
        maneras pues todos los esfuerzos y compromisos con las
        empresas/entidades son bienvenidos. De este modo, es posible:
        <ul class="list">
          <li class="li">
            Aportando fondos económicos que permitan financiar o cofinanciar
            algún proyecto.
          </li>
          <li class="li">
            Promoviendo la RSC de la empresa a través de la acción social que
            realiza la Fundación Don Bosco Salesianos Social
          </li>
          <li class="li">
            Promocionando eventos solidarios en los que se sensibilice y se
            muestre la realidad que atiende la empresa/entidad junto a la
            Fundación Don Bosco Salesianos Social.
          </li>
          <li class="li">
            Patrocinando programas o acciones que reviertan en una relación
            ganar/ganar
          </li>
          <li class="li">
            Realizando donaciones en especie que puedan ser de utilidad para el
            desarrollo de la misión y la actividad de la entidad.
          </li>
          <li class="li">
            Prestando servicios profesionales de manera voluntaria y gratuita
            como expresión de la devolución social.
          </li>
          <li class="li">
            Sensibilizando sobre la labor de la entidad y abriendo a nuevos
            sectores económicos y productivos con los que establecer sinergias
            colaborativas.
          </li>
        </ul>
        ...
        <div class="text--primary">
          Sí. Toda la aportación que hagas a nuestra Fundación se beneficia de
          desgravaciones fiscales que se practican sobre las donaciones
          realizadas por contribuyentes de IRPF y por contribuyentes del
          Impuesto sobre la Renta de No Residentes que operen en territorio
          ...
          tabla
          <table style="background-color: #DADCDE" width="80%" border="1" cellspacing="0" cellpadding="0">
            <tr>
              <td rowspan="3">
                <p >
                  Personas físicas (IRPF) o contribuyentes del Impuesto sobre la
                  Renta de no Residentes que operen en territorio español sin
                  establecimiento permanente
                </p>
              </td>
              <td style="background-color: #DC001B "><p style="color: white;" class="table">80%</p></td>
              <td style="background-color: #DC001B "><p style="color: white;" class="table">35%</p></td>
              <td style="background-color: #DC001B "><p style="color: white;" class="table">40%</p></td>
            </tr>
            <tr>
              <td>
                <p>
              ...
              <td>
                <p>
                  A la cantidad que supere los 150€ donados durante el ejercicio
                  fiscal.
                </p>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <p>
                  Ejemplo: Si donas 200€ te desgravarás 137,5€ en la declaración
                </p>
              </td>
              <td>
                <p>
         ...
         <div class="h2"><img id="icon" src="../assets/icon.png" alt="icon" width="25px;"><h2  class="h2">
           ¿Si hago una aportación como persona jurídica, ¿puedo desgravar mi
            aportación a la Fundación Don Bosco Salesianos Social en el impuesto
            de sociedades?
      </h2></div> 
          ...
          <div class="text--primary">
            Sí. Toda la aportación que hagas a nuestra Fundación se beneficia de
            desgravaciones fiscales que se practican sobre las donaciones
            realizadas por las personas jurídicas (aquellas que tienen un CIF)
            con un límite en el 10% de la base imponible sobre la que se calcula
          ...
          <div class="text--primary">
            Claro que no. Tu donación es voluntaria por lo que puedes donar la
            cantidad que quieras o puedas. Recuerda que cada aportación cuenta y
            es importante para mejorar la vida de las personas e impactar
          ...
          <div class="text--primary">
            Sí, es muy sencillo. Sólo debes acceder a la sección, “Haz una
            donación” (<a href=""
              >Haz una donación - Fundación Don Bosco Salesianos Social</a
            >
            ) y rellenar el formulario con los datos que te solicitan. Con los
